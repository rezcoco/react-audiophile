  ...
  return (
    <div>
      <div className={`ctr py-8 px-0 mx-8 xl:mx-auto flex justify-between items-center border-b border-[#2c2c2c] relative z-[999]`}>
        ...
        <nav aria-label="primary" className="lg:flex hidden justify-center items-center md:gap-x-[34px] mr-auto">
      ...
      { toggle && (
        <nav aria-label="secondary" className="absolute inset-0 h-full z-50">
